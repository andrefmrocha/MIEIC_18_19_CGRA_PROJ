...
class MyTreeGroupPatch extends CGFobject {
    constructor (scene , fruit) {
        ...
        this.tree7 = new MyTree(scene, 1.8 + this.r(-0.2, 0.4), 0.6 + this.r(-0.1, 0.1), 2 + this.r(-0.25, 0.5), 1.2 + this.r(-0.15, 0.15), this.scene.materialWood, this.scene.materialTreeTop,fruit);
        this.tree8 = new MyTree(scene, 1.8 + this.r(-0.2, 0.4), 0.6 + this.r(-0.1, 0.1), 2 + this.r(-0.25, 0.5), 1.2 + this.r(-0.15, 0.15), this.scene.materialWood, this.scene.materialTreeTop,fruit);
        this.tree9 = new MyTree(scene, 1.8 + this.r(-0.2, 0.4), 0.6 + this.r(-0.1, 0.1), 2 + this.r(-0.25, 0.5), 1.2 + this.r(-0.15, 0.15), this.scene.materialWood, this.scene.materialTreeTop,fruit);
        this.x_rand = [];
        this.y_rand = [];
        for (let i = 0; i < 9; i++) {
